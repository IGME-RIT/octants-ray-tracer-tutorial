...
{
	// check for box collision before checking mesh polygons,
	// if there are 50 (or more) polygons in the mesh (36 tris for box)
	m->boolUseMeshBox = m->numTriangles >= 50;

	// check for box collision before checking mesh polygons,
	// if there are 200 (or more) polygons in the mesh (324 tris for 9 boxes)
	m->boolUseMeshDivisionBoxes = m->numTriangles >= 350;
